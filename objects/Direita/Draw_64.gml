...
var x_position = sprite_get_width(sprite_index) * 7;
var y_position = sprite_get_width(sprite_index) *7;
...
draw_sprite_stretched(BotaoRight, 0, x_position, y_position, width, height);
